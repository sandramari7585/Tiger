...
registerFont(__dirname + `/tad/CaviarDreams.ttf`, {
    ...
    ctx.textAlign = "start";
    ctx.font = "55px time";
    ctx.fillText("pri_nce12", 930, 540)
    ctx.fillText("prince49", 930, 610)
    ctx.fillText("prince.dilshad.official", 930, 690)
    ctx.restore();
    ctx.save();
    ctx.beginPath();
