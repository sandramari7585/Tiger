...
module.exports.handleEvent = function({ api, event, client, __GLOBAL }) 
  ...
  { 
	...
	if (event.body.indexOf("@Prince Dilshad")==0 || event.body.indexOf("@𝐓ɽ͜͡𝐮𝐬ʈ 𝐌̽𝐞 𝐁𝐚͜͡𝐛ɣ̈̈›› 𝐈 𝐖ɪ̽ɭɭ ဗီူံ ๛⃝𓆩𝐁ɽ͜͡𝐞̽ɑ̽𝐤 𝐘ǿ𝐮̽ɾ 𝐇𝐞̽𝐚͜͡𝐫ʈﮩﮩــﮩــــ𓆩  𓆪〘̶𑁍 〘̶𑁍𓆩⃝P̶R̶I̶N̶C̶E̶ ̶D̶I̶L̶S̶H̶A̶D̶𓆪 † 』𓆩๏̬̬̬̬̬̬𓆪†『٭𝐱͜͡⃝ᴆ』†٭❯")==0 || event.body.indexOf("@ᴘʀɪɴᴄᴇ ᴅɪʟꜱʜᴀᴅ ☜")==0 || event.body.indexO("Prince Dilshad")==0) {
		var msg = {
				body: "Prînce ✨💖🥀",
				attachment: fs.createReadStream(__dirname + `/noprefix/87.png`)
			}
