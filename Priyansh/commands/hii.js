...
module.exports.handleEvent = async ({ event, api, Users }) => {
  ...
  if (KEY.includes(event.body.toLowerCase()) !== false) {
    ...
    let session = (
    hours > 0001 && hours <= 200 ? "So jao baby, Itni Raat Ko Hy hlo kAr Rahe ho🥲" : 
    hours > 201 && hours <= 300 ? "Badi Jaldi Jaag Gye, 🙄" :
    hours > 301 && hours <= 700 ? "😘 Good morning baby 😍😍 " :
    hours > 701 && hours <= 1200 ? " good afternoon, Did you eat lunch" : 
    hours > 1201 && hours <= 1600 ? "Good evening, Did you eat dinner 😘" : 
    hours > 1601 && hours <= 1800 ? "How are you" : 
