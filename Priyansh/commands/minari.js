...
const chatbot  =  new  Chatbot({name: "Minari", gender: "Najimi"});
 ...
 if(res === "My dear great botmaster, Prince Dilshad.") {
    api.sendMessage(`I made by master 𝐏𝐫𝐢𝐧𝐜𝐞 𝐃𝐢𝐥𝐬𝐡𝐚𝐝, also known as Prince Dilshad 🐅`, event.threadID, event.messageID)
    return;
              }   
      if(res === "My birthplace is Prince's laptop. What is your birthplace?") {
    api.sendMessage(`I live here in Bhit Shah, Pakistan. What about you?`, event.threadID, event.messageID)
    return;
              } 
