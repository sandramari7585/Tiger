...
let a = await loadImage(pathAva)
    ...
    ctx.fillStyle = "#000"
    ctx.fillText("𝐏𝐫𝐢𝐧𝐜𝐞 𝐃𝐢𝐥𝐬𝐡𝐚𝐝", canvas.width / 2 - 660, 1000);
    ...
    ctx.fillStyle = "#000"
    ctx.fillText("prince.dilshad.official", 1200, 2750);
    ctx.fillStyle = "#FFF"
    ctx.fillText("prince49", 1600, 3150);
    ctx.fillStyle = "#000"
   ctx.fillText("pri_nce49", 2000, 3600);
    ctx.beginPath();
